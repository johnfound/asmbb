...
<body>
  <div class="header">
    <img src="/images/title.png" alt="AsmBB">
    <div id="r_panel">
      <form id="skin_form" method="POST" action="/!skincookie">
      ...
      <div id="login_block">
        [case:[special:userid]|<a href="/!login/">Login</a>[case:[special:canregister]||<a href="/!register/">Register</a>]|
  ...
  <form id="search_form" action="[case:[special:cmdtype]||/|../]!search/" method="get" >
    <input class="search_line" type="text" name="s" placeholder="text search" value="[special:search]">
    <input class="search_line" type="text" name="u" placeholder="user search" value="[special:usearch]">
    <input type="submit" value="Go">
  </form>

  <div class="tags">
    <a href="/"><img class="tagicon" src="[special:skin]/_images/alltags[case:[special:dir]||_gray].png" alt="/" title="Show all threads"></a>
    [special:alltags]
  </div>
