...
<div>
  ...
  <a class="editbtn" onclick="insertTag('source', '^[', '^]^[My link^]', 1)" title="Link ^[url^]^[description^]" ><img class="icon_link"      src="[special:skin]/_images/toolbar.svg" alt="Link"></a>
  <a class="editbtn" onclick="insertTag('source', '^[!','^]^[My picture^]', 1)" title="Picture ^[!url^]^[alt text^]"><img class="icon_picture"   src="[special:skin]/_images/toolbar.svg" alt="Image"></a>
