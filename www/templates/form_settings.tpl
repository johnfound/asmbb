...
<form class="settings" method="post" action="/settings">
  ...
  <label for="file_caching">File caching:</label><label class="checkbox"><input type="checkbox" [file_cache] name="file_caching" id="file_caching" class="checkbox"><span>.</span></label><br>
