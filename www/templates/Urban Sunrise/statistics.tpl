...
<p>The latest registered user is: <a class="user" href="/!userinfo/[url:[lastuser]]">[usr:[lastuser]]</a></p>
...
<p>Последно се е регистрирал: <a class="user" href="/!userinfo/[url:[lastuser]]">[usr:[lastuser]]</a></p>
